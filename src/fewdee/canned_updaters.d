 ...
 *
 * These updaters naïve in a certain sense. They simply do their job without
 ...
 *
 * On the other hand, using requires very little effort, and therefore they are
 * an excellent way to make your graphics and interfaces more "lively".
 *
...
/**
 * Adds to a given Updater, an updater function that will change the position of
 * a given object. D's uniform function call syntax allows to call this as if it
 * was a method of Updater.
 *
 * Parameters:
 *    updater = The Updater to which the updater function will be added.
...
/**
 * Adds to a given Updater, an updater function that will change the alpha
 * (opacity) of a given object. D's uniform function call syntax allows to call
 * this as if it was a method of Updater.
 *
   ...
   updater.add(delegate(dt)
               {
                  ...
                  immutable newColor =
                     al_map_rgba_f(r, g, b, alphaInterpolator(t));
...
/**
 * Adds to a given Updater, an updater function that will change the color of a
 * given object. D's uniform function call syntax allows to call this as if it
 * was a method of Updater.
 *
...
/**
 * Adds to a given Updater, an updater function that will change the scale of a
 * given object. D's uniform function call syntax allows to call this as if it
 * was a method of Updater.
 *
 * Parameters:
...
/**
 * Adds to a given Updater, an updater function that will change the rotation of
 * a given object. D's uniform function call syntax allows to call this as if it
 * was a method of Updater.
 *
 * Parameters:
