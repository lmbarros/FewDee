...
# All
all: fewdee.a fewdeedemo.example list_monitors.example states_simple.example #updater_simple.example \
...
list_monitors.example: examples/list_monitors.d fewdee.a
